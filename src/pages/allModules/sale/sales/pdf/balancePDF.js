...
const generatePDF2 = (invoiceData1, type) => {
	...
	vendorTableRows.push([`Shop: ${invoiceData1?.parentData?.store?.name}`]);
	vendorTableRows.push([`Address: ${invoiceData1?.parentData?.store?.address}`]);
