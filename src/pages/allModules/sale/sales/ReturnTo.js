										...
										formik.values.childArray.map((items, index) => (
											<tr className='row' key={items.index}>
												<td className='col-md-4 border-start border-end '>
													...
													<table>
  {formik.values.childArray[index].rackShelf?.map((rack, rackIndex) => (
    <tr className='row mt-2' key={`${rack.racks.rack_number}-${rack.shelves.shelf_number}`}>
      <td className='col-md-4 border-start border-end'>
        <div>
          <FormGroup
            size='sm'
            ...
            <h5 className='col-md-12'>{rack.racks.rack_number}</h5>
          </FormGroup>
        </div>
      </td>
      <td className='col-md-4 border-start border-end'>
        <div>
          <FormGroup
            ...
            <h5>{rack.shelves.shelf_number}</h5>
          </FormGroup>
        </div>
      </td>
        ...
        <div className='col-md-12'>
          <FormGroup
            ...
            <Input
              ...
              value={rack.quantity}
              invalidFeedback={
                formik.errors[`childArray[${index}].rackShelf[${rackIndex}].quantity`]
              }
            />
          </FormGroup>
          {formik.errors[`childArray[${index}].rackShelf[${rackIndex}].quantity`] && (
        ...
        <div className='col-md-12'>
          <FormGroup
            ...
            <Input
              ...
              value={rack.qty_sale}
              invalidFeedback={
                formik.errors[`childArray[${index}].rackShelf[${rackIndex}].qty_sale`]
              }
            />
          </FormGroup>
          {formik.errors[`childArray[${index}].rackShelf[${rackIndex}].qty_sale`] && (
