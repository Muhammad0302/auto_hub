			...
			<div className='row p-1'>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							Item Type:{' '}
							{viewItem?.itemOemDetail.machine_part_oem_part.machine_part.type.name ??
								'none'}
						</strong>
					</CardSubTitle>
				</div>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							Unit:{' '}
							{viewItem?.itemOemDetail.machine_part_oem_part.machine_part.unit.name ??
								'none'}
						</strong>
					</CardSubTitle>
				</div>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							Part Model:{' '}
							{viewItem.itemOemDetail.machine_model?.machine_partmodel
								?.name ?? 'none'}
						</strong>
					</CardSubTitle>
				</div>
			...
			<div className='row p-1'>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							{' '}
							Machine: {viewItem?.itemOemDetail.machines && viewItem.itemOemDetail.machines.map((machines) => machines.name )
							.join(',')}
						</strong>
					</CardSubTitle>
				</div>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							{' '}
							Make: {viewItem?.itemOemDetail.makes && viewItem.itemOemDetail.makes.map((makes) => makes.name )
							.join(',')}
						</strong>
					</CardSubTitle>
				</div>
				<div className='col-md-4'>
					<CardSubTitle>
						<strong>
							Model: {viewItem?.itemOemDetail.machine_models && viewItem.itemOemDetail.machine_models.map((machine_models) => machine_models.name )
							.join(',')}
						</strong>
					</CardSubTitle>
				</div>
