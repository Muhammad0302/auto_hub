						...
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									...
									<div className='text-muted mt-n2 truncate-line-1'>Number of Sales</div>
								</div>
							</div>
						</div>
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									...
									<div className='text-muted mt-n2 truncate-line-1'>Total Price of Sales</div>
								</div>
							</div>
						</div>
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									...
									<div className='text-muted mt-n2 truncate-line-1'>Total Payable</div>
								</div>
							</div>
						</div>
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									...
									<div className='text-muted mt-n2 truncate-line-1'>Total Recievable</div>
								</div>
							</div>
						</div>
					</div>
